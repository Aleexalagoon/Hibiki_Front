  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <form @submit.prevent="loginUser">
        ...
        <div class="links">
          <a href="/register" class="signup">¿No tienes cuenta? <span>Regístrate en Hibiki</span></a>
          <a href="/loginzonaprivada" class="staff-login">Si eres trabajador <span>pulsa aquí</span></a>
        </div>
      </form>
    </div>
  </div>
